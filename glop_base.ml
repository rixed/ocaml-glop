...
struct
	...
	external mult_projection  : M.t -> unit = "gl_mult_projection"
	external push_projection  : unit -> unit = "gl_push_projection"
	external pop_projection   : unit -> unit = "gl_pop_projection"
